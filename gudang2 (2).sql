...
INSERT INTO `barang` (`nama_barang`, `id_barang`, `jenis_barang`, `status`, `ketersediaan`) VALUES
('kurumi', 19, 'boneka', 'baik', 'tersedia'),
('cardigan', 21, 'pakaian', 'baik', 'tidak tersedia'),
('chichi', 24, 'perempuan', 'rusak', 'tidak tersedia');
